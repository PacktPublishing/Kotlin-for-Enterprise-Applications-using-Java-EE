package org.rao.kotlin.microservices.authentication.jwt
...
object JWTUtil {
    ...
    public fun verifyJwt(token: String) :Long {
        ...
        return (claims.expiration.time - System.currentTimeMillis())/1000
